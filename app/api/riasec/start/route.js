...
import { generateTestToken, getTokenExpiration } from '@/lib/riasec/calculateRIASEC';

// POST - Start RIASEC test for a patient
export async function POST(request) {
  try {
    ...
    console.error('Start RIASEC test error:', error);
    return NextResponse.json(
